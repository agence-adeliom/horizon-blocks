...
class SearchEngineResultsBlock extends AbstractBlock
{
	...
	{
		return __('Résultats du moteur de recherche', 'horizon-blocks');
	}

	public static function getDescription(): ?string
	{
		return __('Affiche les résultats de la recherche du site avec pagination.', 'horizon-blocks');
	}

	public function getFields(): ?iterable
	{
		if ($configUrl = SearchEngineService::getSearchEngineConfigPageUrl()) {
			yield Message::make(__('Configuration du moteur de recherche', 'horizon-blocks'))
